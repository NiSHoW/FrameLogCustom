...
namespace FrameLog.Tests
{
    public class LoggingTests : DatabaseBackedTest
    {
        ...
        {
            var bookshelf1 = new Bookshelf() { Id = 0, Name = "Comedy books" };
            var bookshelf2 = new Bookshelf() { Id = 0, Name = "Horror books" };
            Action theChange = () =>
            {
            ...
            Assert.AreEqual(bookshelf1.Id.ToString(), changeBookshelf1.ObjectReference, "Object references for bookshelf 1 do not match, but they should");
            Assert.IsNotNull(changeBookshelf2, "Expected changes for bookshelf 2, but there were none");
            Assert.AreEqual(bookshelf2.Id.ToString(), changeBookshelf2.ObjectReference, "Object references for bookshelf 2 do not match, but they should");
        }
